            ...
            <form action="./php/usuario_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" >
                ...
                <div class="row g-3">
                    <div class="col-md-4"><label for="nombre" class="form-label">Nombre</label>
                        <input type="text" name="usuario_nombre" pattern="[a-zA-ZáéíóöúüÁÉÍÓÖÚÜñÑ]{3,40}" title="Caracter no permitido" maxlength="40" required id="" class="form-control">
                    </div>
                    <div class="col-md-4"><label for="apellido" class="form-label">Apellido</label>
                        <input type="text" name="usuario_apellido" pattern="[a-zA-ZáéíóöúüÁÉÍÓÖÚÜñÑ]{3,40}" title="Caracter no permitido" maxlength="40" required id="" class="form-control">
                    </div>
                    ...
                    <div class="col-md-4"><label for="email" class="form-label">Email</label>
                        <input type="email" name="usuario_email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" maxlength="20"  id="" class="form-control">
                    </div>
